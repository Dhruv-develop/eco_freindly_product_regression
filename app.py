...
avg_temp = st.sidebar.slider("Average Temperature (°C)",0,44,25)

google_trend_score = st.sidebar.slider("Google Trend Score",0,100,50)

marketing_spend = st.sidebar.number_input("Marketing Spend",0,120,75)

store_visits = st.sidebar.number_input("Store Visits",99,210,150)
